...
print(f"Maximum value: {knapsack(weights, values, capacity)}")`,
  ...
  const renderTopics = (topics: { title: string; description: string; code?: string; icon?: string; difficulty?: string; definition?: string; keyConcepts?: string[]; explanation?: string; }[], language: string) => (
