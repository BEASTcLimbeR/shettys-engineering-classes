...
export const metadata: Metadata = {
  title: {
    default: "Shettys Engineering Classes - Best Engineering Classes in Pune | Expert Coaching Since 2010",
    template: "%s | Shettys Engineering Classes"
  },
  description: "Shettys Engineering Classes - Best First Year Engineering Class in Pune. Leading engineering coaching institute offering personalized coaching for E&TC, Computer, Electrical, AI&DS, Mechanical, Civil branches. Expert guidance, small batches, proven results since 2010. Book free demo today!",
  keywords: keywordString,
  authors: [{ name: "Shettys Engineering Classes", url: "https://shettysengineeringclasses.com" }],
  ...
  openGraph: {
    title: "Shettys Engineering Classes - Best Engineering Classes in Pune | Expert Coaching Since 2010",
    description: "Shettys Engineering Classes - Best First Year Engineering Class in Pune. Leading engineering coaching institute offering personalized coaching for E&TC, Computer, Electrical, AI&DS, Mechanical, Civil branches. Expert guidance, small batches, proven results since 2010. Book free demo today!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Shettys Engineering Classes Logo - Best Engineering Coaching in Pune",
        type: 'image/svg+xml',
      },
    ],
    locale: 'en_US',
  ...
  twitter: {
    ...
    description: "Shettys Engineering Classes - Best First Year Engineering Class in Pune. Leading engineering coaching institute offering personalized coaching for all engineering branches since 2010. Book free demo today!",
  ...
  other: {
    ...
    'DC.title': "Shettys Engineering Classes - Best Engineering Classes in Pune | Expert Coaching Since 2010",
    'DC.creator': "Shettys Engineering Classes",
    'DC.subject': 'Engineering Coaching, Engineering Classes, Engineering Tuition, Engineering Exam Preparation',
    'DC.description': 'Shettys Engineering Classes - Best First Year Engineering Class in Pune. Leading engineering coaching institute offering personalized coaching for E&TC, Computer, Electrical, AI&DS, Mechanical, Civil branches.',
    'DC.publisher': "Shettys Engineering Classes",
    'DC.contributor': "Shettys Engineering Classes",
    'DC.date': '2010-01-01',
    'DC.type': 'Text',
    'DC.format': 'text/html',
    ...
    'DC.rights': 'Copyright 2024 Shettys Engineering Classes',
    'DC.source': 'https://shettysengineeringclasses.com',
    'DC.relation': 'https://shettysengineeringclasses.com',
    
    // Additional SEO meta data
    'author': "Shettys Engineering Classes",
    'copyright': 'Copyright 2024 Shettys Engineering Classes',
    'language': 'en',
    'distribution': 'global',
    'rating': 'general',
    ...
    // Business meta data
    'business:contact_data:street_address': "Shettys Engineering Classes, 3rd Floor Besides Namaskar Restaurant, Ghole Rd, opposite MJM Hospital, Sud Nagar, Shivajinagar, Pune, Maharashtra 411004",
    ...
    'education:institution_name': "Shettys Engineering Classes",
    ...
    'place:business:name': "Shettys Engineering Classes",
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="author" content="Shettys Engineering Classes" />
        <meta name="copyright" content="Copyright 2024 Shettys Engineering Classes" />
        ...
        {/* Business Meta Tags */}
        <meta name="business:contact_data:street_address" content="Shettys Engineering Classes, 3rd Floor Besides Namaskar Restaurant, Ghole Rd, opposite MJM Hospital, Sud Nagar, Shivajinagar, Pune, Maharashtra 411004" />
        ...
        <meta name="education:institution_name" content="Shettys Engineering Classes" />
        ...
        <meta name="place:business:name" content="Shettys Engineering Classes" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "address": {
                "@type": "PostalAddress",
                "streetAddress": "Shettys Engineering Classes, 3rd Floor Besides Namaskar Restaurant, Ghole Rd, opposite MJM Hospital, Sud Nagar, Shivajinagar, Pune, Maharashtra 411004",
